...
with open('image_labels_single_pa.csv', newline='') as csvfile:
	...
	print("Starting K-Means classifier training.")
	print(". . .")
	kmeans = MiniBatchKMeans(n_clusters=num_clusters, random_state=0)
	kmeans.fit_predict(data)
	print("K-Means classifier training complete. Cluster centers array shape: ", kmeans.cluster_centers_.shape)
	print()
	...
	for n in range(kmeans.cluster_centers_.shape[0]):
